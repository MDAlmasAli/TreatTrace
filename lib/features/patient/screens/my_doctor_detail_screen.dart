// my_doctor_detail_screen.dart — Doctor profile + their appointment history.
...
class MyDoctorDetailScreen extends StatefulWidget {
  final Doctor doctor;
  const MyDoctorDetailScreen({super.key, required this.doctor});

  @override
  State<MyDoctorDetailScreen> createState() => _MyDoctorDetailScreenState();
}

class _MyDoctorDetailScreenState extends State<MyDoctorDetailScreen> {
