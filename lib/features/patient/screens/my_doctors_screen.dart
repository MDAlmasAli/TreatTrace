// my_doctors_screen.dart — Personal doctor book: list, search, specialty filter.
...
import 'my_doctor_detail_screen.dart';
  ...
  Future<void> _openDetail(Doctor d) async {
    if (d.sourceId != null) {
      ...
      final changed = await Navigator.of(context).push<bool>(
        MaterialPageRoute(builder: (_) => MyDoctorDetailScreen(doctor: d)),
      );
